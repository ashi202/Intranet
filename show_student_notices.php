...
<head>
  ...
  <title>Student Related Notices</title>
...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./show_student_notices" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
                  <p>Notices</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        $sql = "SELECT id FROM notices_type WHERE type='STUDENT RELATED'"; 
        $result=mysqli_query($conn,$sql);
        while($rows=mysqli_fetch_assoc($result)){
            $type=$rows["id"];
        }
                    
                      $sql = "SELECT type,date,sess,pdf_file FROM notices WHERE type='$type'";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo  "</td><td>" . $row["sess"] ."</td><td>" . $row["date"] . "</td><td><a href='" .$res."'download>Notice : " .  $row["date"]."</a></td></tr>" ;
    }
