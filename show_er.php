          ...
          <ul class="nav nav-treeview">
           ...
           <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./show_er" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
                  <p>Exam Regulation</p>
                </a>
              </li>
    ...
    <section class="content">
        ...
        while($rows=mysqli_fetch_assoc($result)){
           $prog=$rows["id"];
                      ...
                      $sql = "SELECT prog,type,pdf_file FROM academic_downloads WHERE prog='$prog' and type='EXAM REGULATIONS'";
$result = $conn->query($sql);
if($result){
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
      ...
      $res="./private_html/private_a/dist/img_dir/".$res;
        echo "<tr><td>". $prog1. "</td><td><a href='" .$res."'download>Syllabus : " . $prog1."</a></td></tr>" ;
    }
