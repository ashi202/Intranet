        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./show_timetable" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
                  <p>Timetable</p>
                </a>
  </li>
    ...
    <section class="content">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Timetable:<?php 
        ...
        $sess=$_POST["sess"].' '.$_POST["sess_y"];
                      ...
                      $sql = "SELECT dept,sess,pdf_file FROM timetable WHERE dept='$dept'  and sess='$sess'";
$result = $conn->query($sql);
if($result){
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
      ...
      $res="./private_html/private_a/dist/img_dir/".$res;
        echo "<tr><td>". $row["dept"]. "</td><td>" . $row["sess"] . "</td><td><a href='" .$res."'download>Timetable : " .$row["dept"]."</a></td></tr>" ;
    }
