...
<head>
  ...
  <script>
    function chng1(){
      ...
      str= select.value;
      xmlhttp.open("GET","helper4.php?value="+str+"&semval="+output,true);
      xmlhttp.send()
    }
    </script>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./show_projects" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
                  <p>Project Report</p>
                </a>
              </li>
    ...
    <section class="content">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Projects with details</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo "<tr><td>". $row["prog"]. "</td><td>". $row["sub_code"]."</td><td>" .$row["subject_name"]."</td><td>" . $row["sess"] . "</td><td>" . $row["semester"]."</td><td><a href='" .$res."'download>Project : " .$row["subject_name"]."</a></td></tr>" ;
    }
