    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Upload Forms</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="forms_chk.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <label>Upload Form</label> <label style="color: red">(*only in pdf format*)</label>
