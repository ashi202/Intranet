...
<head>
  ...
  <script>
    ...
    function chng1(){
      ...
      str= select.value;
      xmlhttp.open("GET","helper3.php?value="+str+"&semval="+output,true);
      xmlhttp.send()
    }
    </script>
</head>
    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Upload Projects</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
echo "<option value='".$row["sess"]."'>". $row["sess"];
  ...
  ?>
                  ...
                  <div class="form-group">
                    ...
                    <label>Upload Project</label> <label style="color: red">(*only in pdf format*)</label>
