...
$sql = "SELECT sub_code FROM subjects WHERE prog_id='$id' AND sem_id='$id1' AND type='PROJECT'"; 
$result=mysqli_query($conn,$sql);

if(mysqli_num_rows($result)>0){
    echo "<label>Subject</label><select class='form-control' name='sub_code' onchange='chng(this.value);'><option>Select Code</option>";
