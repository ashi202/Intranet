    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Upload Subjects</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="sub_chk.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Program</label>
                        <select class="form-control" name="prog" id='selectpr' >
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="sem" id='selectop' >
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group" id="poll1">
                        ...
                        <input type="text" class="form-control" placeholder="(Example: CA/MT/AMXXX)" name="sub_code">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group"  id="poll">
                        ...
                        <input type="text" class="form-control" placeholder="(Example: Data Structure and Algorithm)" name="subject_name">
                      </div>
                    </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control"  id='selectpr' name="subject_type" >
