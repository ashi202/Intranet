...
<head>
  ...
  <title>Upload Academic Downloads</title>
  ...
  <script>
    ...
    function chng1(str){
      ...
      xmlhttp.open("GET","helper6.php?value="+str,true);
      xmlhttp.send()
    }
    </script>
</head>
       ...
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <ul class="nav nav-treeview">
          ...
          <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./academic_downloads" class="nav-link active" >
                  <i class="nav-icon fas fa-table"></i>
    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Upload Academic Downloads</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="academic_chk.php" method="post" enctype="multipart/form-data">
...
echo "<option value='".$row["prog"]."'>". $row["prog"];
  ...
  ?>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="type" onchange="chng(this.value);chng1(this.value);" >
                        ...
                        <option value="EXAM REGULATIONS">EXAM REGULATIONS</option>
                        </select>
                      </div>
                    </div>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <label>Upload Academic Downloads</label> <label style="color: red">(*only in pdf format*)</label>
