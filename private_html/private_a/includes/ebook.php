       ...
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <ul class="nav nav-treeview">
           ...
           <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="./ebook.php" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
                  <p>Upload e-book</p>
                </a>
              </li>
    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Upload ebook</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="chk2.php" method="post" enctype="multipart/form-data">
...
echo "<option value='".$row["sess"]."'>". $row["sess"];
  ...
  ?>
                  ...
                  <div class="form-group">
                    ...
                    <label>Upload ebook</label> <label style="color: red">(*only in pdf format*)</label>
