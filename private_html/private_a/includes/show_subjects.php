        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./show_subjects" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
                  <p>Show Subjects</p>
                </a>
              </li>
    ...
    <section class="content">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Subjects <?php if(isset($_POST['submit'])){ echo " - ". $_POST["prog"]." : ".$_POST["sem"]." semester";}?></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
        ...
        while($rows=mysqli_fetch_assoc($result)){
           $semester=$rows["id"];
                      ...
                      $sql = "SELECT sub_code,subject_name,type FROM subjects WHERE prog_id='$prog' and sem_id=$semester";
$result = $conn->query($sql);
if($result){
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".  $row["sub_code"]."</td><td>" .$row["subject_name"]."</td><td>" .$row["type"]. "</td></tr>" ;
    }
