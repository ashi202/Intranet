...
<head>
  ...
  <title>Academic Downloads</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="./show_academic" class="nav-link active">
                  <i class="nav-icon fas fa-table"></i>
    ...
    <section class="content">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Academic Downloads with Details</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
        ...
        while($rows=mysqli_fetch_assoc($result)){
           $prog=$rows["id"];
                      ...
                      $sql = "SELECT prog,type,about,pdf_file,applicable FROM academic_downloads WHERE prog='$prog' and type='$type'";
$result = $conn->query($sql);
if($result){
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
      $res = strtoupper(str_replace("../dist/img_dir/",'',$row["pdf_file"]));
        echo "<tr><td>". $prog1. "</td><td>". $row["type"]."</td><td><a href='" .$row["pdf_file"]."'download>" .  $res."</a></td><td>".$row["applicable"]."<td></td>".$row["about"]."</td></tr>" ;
    }
