...
<head>
  ...
  <title>Upload Events Organised</title>
         ...
         <ul class="nav nav-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./events_organised" class="nav-link active" >
                  <i class="nav-icon fas fa-table"></i>
    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Upload Events Organised</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="events_chk.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        <label>Organized By<label style="color:red;">*</label></label>
                        <select class="form-control" name="club_name" >
                          
                          <option>Select Organized By</option>
                          <option value="Club & Society">Club & Society</option>
                          <option value="HIGL">HIGL</option>
                    ...
                    <div class="form-group">
                      <label>Organize<label style="color:black;">r</label></label>
                        <input type="text" class="form-control" name="dep" style="width:400px;" placeholder="MCA/BCA/COMPUTER SCIENCE/MANAGEMENT">
                      </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                      <label>Event Title<label style="color:red;">*</label></label>
                ...
                <!-- Date -->
                <div class="form-group">
                  <label>Event Date<label style="color:red;">*</label></label>
                  ...
                  <div class="form-group">
                    ...
                    <label>Upload Event Report</label> <label style="color: red">(*only in pdf format*)<label style="color:red;">*</label></label>
                  ...
                  <div class="form-group">
                    <!-- <label for="customFile">Custom File</label> -->
                    <label>Upload Event Report</label> <label style="color: red">(*only in jpg/jpeg format*)<label style="color:red;">*</label></label>
                    <div class="custom-file">
