...
<head>
  ...
  <title>Upload Club & Society</title>
         ...
         <ul class="nav nav-treeview">
          ...
          <ul class="nav nav-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./club_society" class="nav-link active" >
                  <i class="nav-icon fas fa-table"></i>
    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="card card-warning">
              <div class="card-header">
                <h3 class="card-title">Upload Club & Society</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="club&society_chk.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="club_name" >
                          ...
                          <option value="Department Of">Department Of</option>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                      <label>Faculty Advisor<label style="color:red;">*</label></label>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                      <label>Student Members<label style="color:red;">*</label></label>
                        <input type="text" class="form-control" placeholder="Student1(MCA/45000/22),Student1(BCA/45001/21) and so on..." name="student">
                      </div>
                    </div>
