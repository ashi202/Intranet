...
<head>
  ...
  <title>VISION, MISSION, PEO & PO</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./show_mv" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
             ...
             <li class="nav-item">
               <a href="./show_course" class="nav-link">
                 <i class="nav-icon fas fa-table"></i>
    ...
    <section class="content">
        ...
        while($rows=mysqli_fetch_assoc($result)){
           $prog=$rows["id"];
                      ...
                      $sql = "SELECT prog,type,pdf_file,applicable FROM academic_downloads WHERE prog='$prog' and type='VISION & MISSION' or type='PSO' or type='PEO'";
$result = $conn->query($sql);
if($result){
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
      ...
      echo "<tr><td>". $prog1."</td><td>".$row["type"]."</td><td><a href='" .$res."'download>File : " .$row["type"]."</a></td><td>".$row["applicable"]."</td></tr>" ;
    }
